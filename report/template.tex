...
\newcommand{\wtov}{\textit{Word2Vec}}
\newcommand{\fsttxt}{\textit{Fasttext}}


\newcommand\mycirc[1]{%
    \begin{tikzpicture}[baseline=(C.base)]
        \node[draw,circle,inner sep=1pt,black,fill=white](C) {\footnotesize{#1}};
    \end{tikzpicture}}%


\providecommand{\algorithmicfont}{}
\providecommand{\setalgorithmicfont}[1]{\renewcommand{\algorithmicfont}{#1}}
\renewcommand{\algorithmiccomment}[1]{{\scriptsize\hfill$\triangleright$ #1}}
\makeatletter
...
%%
%%
%GANTT Diagram - Uncomment if need it
%\begin{landscape}
%\centering
%\vspace*{\fill}
%\resizebox{1.5\textwidth}{!}{
%\printganttdiagram
%\InputIfFileExists{Chapters/ganttdiagram}{%
