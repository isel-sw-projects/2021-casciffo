...
## 1 Infrastructure [to review and tie together neatier when more is known; explore features of react, reason of choice]
...
![FIGURE SHOWING CLINICAL TRIAL PATIENTS ]()

![FIGURE SHOWING CLINICAL TRIAL ADD PATIENT ]()
...
When a visit occurs, the associated investigators are given access to the observations ("Observações") field and adverse event ("Evento adverso") warning. In addition to this, a field called "Marcar presença" is now present to mark attendance.