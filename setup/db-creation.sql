...
DROP DATABASE IF EXISTS casciffo_db;
--
-- Name: casciffo_db; Type: DATABASE; Schema: -; Owner: vp
--

CREATE DATABASE casciffo_db WITH TEMPLATE = template0 ENCODING = 'UTF8';


ALTER DATABASE casciffo_db OWNER TO vp;
